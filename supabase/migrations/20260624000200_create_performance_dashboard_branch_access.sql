-- Create branch-level access mapping for performance dashboard users
...
DROP POLICY IF EXISTS "Admin and super_admin can manage performance dashboard branch access" ON public.performance_dashboard_branch_access;
DROP POLICY IF EXISTS "Users can view their own performance dashboard branch access" ON public.performance_dashboard_branch_access;
